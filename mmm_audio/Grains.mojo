...
struct TGrains[max_grains: Int = 1, T: Grainable = Grain[], win_type: Int = WindowType.hann, custom_curve: Int = WindowType.none](Movable, Copyable):
    """
    ...
    @always_inline
    def next_all[num_chans: Int, bWrap: Bool = False](mut self, buffer: SIMDBuffer[num_chans], gain: Float64 = 1.0, num_speakers: Int = 2, width: Float64 = 2.0, orientation: Float64 = 0.5) -> MFloat[num_chans]:
        """Generate the next set of grains. Depending on num_out_chans, will either pan a mono signal out 2 channels or a stereo signal out 2 channels.
